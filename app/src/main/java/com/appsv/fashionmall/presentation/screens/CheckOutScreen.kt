                ...
                Column(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column {
                            ...
                            Text(
                                text = "BDT ${state.value.userData!!.price}",
                                style = MaterialTheme.typography.bodyLarge,
                    ...
                    Column {
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            RadioButton(
                                selected = selectedMethod.value == "Standard FREE delivery over BDT. 4500",
                                onClick = {
                                    selectedMethod.value = "Standard FREE delivery over BDT. 4500"
                                }
                            )
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            RadioButton(
                                selected = selectedMethod.value == "Cash on delivery BDT.50",
                                onClick = { selectedMethod.value = "Cash on delivery BDT.50" }
                            )
                            Spacer(modifier = Modifier.width(8.dp))
                            Text("Cash on delivery BDT.50")
                        }
                    }
                    Spacer(modifier = Modifier.height(16.dp))
